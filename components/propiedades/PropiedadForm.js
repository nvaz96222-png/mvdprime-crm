...
export default function PropiedadForm({
  ...
  const [form, setForm] = useState({
    titulo: propiedad?.titulo || prefill?.titulo || "",
    tipo: propiedad?.tipo || prefill?.tipo || TIPOS[0].value,
    operacion: propiedad?.operacion || prefill?.operacion || OPERACIONES[0].value,
    estado: propiedad?.estado || "disponible",
    precio: propiedad?.precio ?? prefill?.precio ?? "",
    moneda: propiedad?.moneda || prefill?.moneda || "USD",
    descripcion: propiedad?.descripcion || prefill?.descripcion || "",
    propietario_id: propiedad?.propietario_id || propietarioDefault || "",
    agente_id: propiedad?.agente_id || prefill?.agente_id || agenteDefault || "",
    direccion: propiedad?.direccion || "",
    barrio: propiedad?.barrio || prefill?.barrio || "",
    departamento: propiedad?.departamento || prefill?.departamento || "",
    dormitorios: propiedad?.dormitorios ?? prefill?.dormitorios ?? "",
    banos: propiedad?.banos ?? prefill?.banos ?? "",
    superficie_total: propiedad?.superficie_total ?? prefill?.superficie_total ?? "",
    superficie_cubierta: propiedad?.superficie_cubierta ?? prefill?.superficie_cubierta ?? "",
    ...
    parking: propiedad?.parking || prefill?.parking || false,
